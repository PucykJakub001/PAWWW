...
if ($idp == '' || $idp == 'glowna') { 
    $id_strony = 1; 
} elseif ($idp == 'oferta') { // $idp == 'nazwa strony' pochodzi z index.php ::59
    $id_strony = 2; 
    ...
    $id_strony = 5; 
} elseif ($idp == 'filmy') { // $idp == 'nazwa strony' pochodzi z index.php ::61
    $id_strony = 6;
} elseif ($idp == 'kontakt') { // $idp == 'nazwa strony' pochodzi z index.php ::60
    $id_strony = 7;
} elseif ($idp == 'nowa') { 
    $id_strony = 8; // LAB 7 za pomocą CMS dodajemy strone ale w index.php musimy ręcznie wprowadzać warunek 
} elseif ($idp == 'nowa1') { 
    $id_strony = 15; // LAB 7 za pomocą CMS dodajemy strone ale w index.php musimy ręcznie wprowadzać warunek 
}
?>
